function publicaComentario() {
    ...
    var dados = JSON.parse(localStorage.getItem("dadosComent_livro"));

    if (dados == null) {
        localStorage.setItem("dadosComent_livro", "[]");
        dados = [];  //cria o array
    } 
    var auxRegistro = {
        nome: formName.value,
    ...
    localStorage.setItem("dadosComent_livro", JSON.stringify(dados));
