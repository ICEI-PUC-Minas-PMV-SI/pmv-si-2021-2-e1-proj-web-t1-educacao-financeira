function publicaComentario() {
    ...
    var dados = JSON.parse(localStorage.getItem("dadosComent_influencer"));

    if (dados == null) {
        localStorage.setItem("dadosComent_influencer", "[]");
        dados = [];  //cria o array
    } 
    var auxRegistro = {
        nome: formName.value,
    ...
    localStorage.setItem("dadosComent_influencer", JSON.stringify(dados));
