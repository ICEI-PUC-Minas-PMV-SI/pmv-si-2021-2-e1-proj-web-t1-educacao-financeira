function publicaComentario() {
    ...
    var dados = JSON.parse(localStorage.getItem("dadosComent_app"));

    if (dados == null) {
        localStorage.setItem("dadosComent_app", "[]");
        dados = [];  //cria o array
    } 
    var auxRegistro = {
        nome: formName.value,
    ...
    localStorage.setItem("dadosComent_app", JSON.stringify(dados));
